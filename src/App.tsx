    ...
    <section className="relative min-h-screen flex items-center pt-32 lg:pt-0 overflow-hidden bg-brand-cream">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 w-full grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
        ...
        >
          ...
          <motion.h1 variants={fadeUp} className="text-3xl sm:text-4xl lg:text-6xl xl:text-7xl font-serif font-light tracking-tight leading-[1.1] mb-6">
            Cerramos tratos, <br/>
          ...
          <motion.p variants={fadeUp} className="text-base sm:text-lg break-words lg:text-xl text-brand-grey-blue font-light mb-10 max-w-lg leading-relaxed">
        ...
        <motion.div 
          ...
          className="bg-brand-white p-4 sm:p-6 lg:p-8 rounded-xl border border-brand-beige-light shadow-[0_4px_20px_rgba(191,158,119,0.05)] w-full max-w-md relative"
        >
          ...
          <form className="space-y-4" onSubmit={(e) => { e.preventDefault(); window.open(WHATSAPP_URL, '_blank'); }}>
            <div>
              <input type="text" required className="w-full max-w-md bg-brand-white border border-brand-beige-medium rounded-md px-4 py-3 text-sm focus:outline-none focus:border-brand-gold transition-colors text-brand-navy shadow-sm" placeholder="Tu nombre completo" />
            </div>
            <div className="flex gap-3 flex-wrap">
              <input type="tel" required className="flex-1 min-w-[140px] bg-brand-white border border-brand-beige-medium rounded-md px-4 py-3 text-sm focus:outline-none focus:border-brand-gold transition-colors text-brand-navy shadow-sm" placeholder="Teléfono" />
              <select className="flex-1 min-w-[140px] bg-brand-white border border-brand-beige-medium rounded-md px-4 py-3 text-sm focus:outline-none focus:border-brand-gold transition-colors text-brand-navy appearance-none shadow-sm">
            ...
            <div className="flex flex-col sm:flex-row gap-3">
              ...
              <button type="submit" className="bg-brand-gold text-brand-white px-6 py-3 sm:py-0 rounded-md text-sm font-bold tracking-widest hover:bg-opacity-90 transition-colors uppercase whitespace-nowrap">
                Empezar
              </button>
            </div>
...
export default function App() {
  return (
    <div className="min-h-screen font-sans bg-brand-cream text-brand-navy selection:bg-brand-gold selection:text-brand-cream overflow-x-hidden">
      <Navbar />
      <Hero />
      <AuthorityStats />
      <Services />
